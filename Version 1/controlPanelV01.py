...
and rects used by the ControlPanel module and the TextEditor module and finally
the pygame module used to display the GUI for the program which can be found at
the address http://pygame.org/.
...
class keywordSearch(object):
    def __init__(self, textEditor, borderColour=(224, 224, 224), font="agencyfb"):
        ...
        self.unrenderedText = ["testing editor"]
        self.renderedText = []
        self.lineRects = []
    ...
    def updateSurfaces(self):
        ...
        self.searchLayer = pygame.Surface((
            displayConstants.controlLayer.get_width() - 30,
            displayConstants.controlLayer.get_height() - 35
        ))

        #the slidebar layer
        self.slidebarLayer = pygame.Surface((
            30, displayConstants.controlLayer.get_height() - 35
        ))
    ...
    def blitSurfaces(self):
        ...
        displayConstants.controlLayer.blit(self.slidebarLayer, (self.searchLayer.get_width(), 35))
