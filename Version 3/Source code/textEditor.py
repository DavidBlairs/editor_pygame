...
displayConstants found locally as "displayConstants.py" and the pygame module
found at http://pygame.org/.
...
class textEditor(object):
    def __init__(self, borderColour=(244, 244, 244), fontType="agencyfb", fontSize=22):
        ...
        self.unrenderedText = ["" for i in range(10)]
        self.renderedText = []
        self.textRects = []
        self.lineRects = []
        ...
        #colours for the movement buttons
        self.moveUpBackgroundColour = (200, 200, 200)
        self.moveDownBackgroundColour = (200, 200, 200)
        self.moveLeftBackgroundColour = (200, 200, 200)
        self.moveRightBackgroundColour = (200, 200, 200)
    ...
    def loopUpdate(self):
        ...
        self.moveUpLayer.fill(self.moveUpBackgroundColour)
        ...
        self.moveDownLayer.fill(self.moveDownBackgroundColour)
        ...
        if self.moveUpRect.collidepoint(pygame.mouse.get_pos()):
            self.moveUpBackgroundColour = (180, 180, 180)
        ...
        if self.moveDownRect.collidepoint(pygame.mouse.get_pos()):
            self.moveDownBackgroundColour = (180, 180, 180)
        ...
        self.moveLeftLayer.fill(self.moveLeftBackgroundColour)
        self.moveRightLayer.fill(self.moveRightBackgroundColour)
        ...
        if self.moveLeftRect.collidepoint(pygame.mouse.get_pos()):
            self.moveLeftBackgroundColour = (180, 180, 180)
        ...
        if self.moveRightRect.collidepoint(pygame.mouse.get_pos()):
            self.moveRightBackgroundColour = (180, 180, 180)
    ...
    def checkEvent(self, event):
        ...
        if event.key >= pygame.K_SPACE and event.key <= 127:
            if self.currentlyEditing and self.cursorLocation != None:
